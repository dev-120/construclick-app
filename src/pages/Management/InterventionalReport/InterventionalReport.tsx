...
import "./InterventionalReport.css";
...
const InterventionalReport: React.FC = () => {
  const handleDismiss = () => {
    dismiss();
  };
...
const ReportCard = ({
  ...
  const [observationsArea, setObservationsArea] =  useState("")
  return (
    <IonCard>
      <IonCardHeader>
            ...
            <IonRow>
              <IonCol size="6">
                <IonRadioGroup value={radioSelected} onIonChange={(e) => setRadioSelected(e.detail.value!)}>
                  <IonItem lines="none">
                    <IonRadio value="fulfill"  />
                    <IonLabel>Cumple</IonLabel>
                  </IonItem>
                  <IonItem lines="none">
                    <IonRadio value="fails"  />
                    <IonLabel>No cumple</IonLabel>
                  </IonItem>
                  <IonItem lines="none">
                    <IonRadio value={otherInput}  />
              ...
              <IonCol size="6">
                <IonItem >
                  <IonTextarea autoGrow  value={observationsArea} onIonChange={(e) => setObservationsArea(e.detail.value!)} placeholder="Ingrese Observaciones" />
                </IonItem>
              </IonCol>
            </IonRow>
            <IonRow>
              <IonCol>
                <IonButton expand="full" onClick={() => onDismiss()}>Guardar</IonButton>
              </IonCol>
            </IonRow>
          </IonGrid>
        </IonCardContent>
...
export default InterventionalReport;
