    ...
    <IonPage>
      ...
      <IonContent>
        ...
        <IonList>
          ...
          <IonItem button onClick={() => setShowNewItem(true)}>
      ...
      <IonCardContent>
        <IonList>
          ...
          <IonItem >
            ...
            <IonInput type="number" placeholder="Ingrese presupuesto" value={budget}  onIonChange={(e) => setBudget(parseInt(e.detail.value!))} />
          </IonItem>
          <IonItem >
            <IonIcon slot="start" icon={book} />
            <IonLabel>Cantidad: </IonLabel>
            <IonInput type="number" />
            <IonSelect value={selectedOption} onIonChange={(e) => setSelectedOption(e.detail.value!)} >
