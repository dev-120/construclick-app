    ...
    <IonMenu side="start" contentId="main">
      <IonContent className="content_menu_side" >
        <div className="cover_menu_profile" >
          <IonImg className="cover_menu_profile_img" src="https://images.unsplash.com/photo-1429497419816-9ca5cfb4571a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80" />
          ...
          <div className="data_profile_menu_side" >
            ...
            <div className="data_text_profile_menu_side" >
              <span className="data_text_profile_menu_side-name" >Johnny Pacheco</span>
              <span className="data_text_profile_menu_side-profession" >Arquitecto</span>
            </div>
          </div>
        </div>
